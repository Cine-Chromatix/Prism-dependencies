...
def get_exe():
    ...
    if platform.system() == "Windows":
        pipeFFMPEG = os.path.join(os.getenv("localappdata"), "Prism", "Tools", "FFmpeg" ,"bin", "ffmpeg.exe")
    elif platform.system() == "Linux":
        return "ffmpeg"
    elif platform.system() == "Darwin":
        pipeFFMPEG = "/Applications/Prism/Prism/Tools/ffmpeg"

    if os.path.exists(pipeFFMPEG):
        return pipeFFMPEG
